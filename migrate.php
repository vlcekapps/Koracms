...
$tables = [
    ...
    'cms_blog_series' => "CREATE TABLE IF NOT EXISTS cms_blog_series (
        id          INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        blog_id     INT          NOT NULL,
        title       VARCHAR(255) NOT NULL,
        slug        VARCHAR(255) NOT NULL,
    ...
    'cms_blog_series_items' => "CREATE TABLE IF NOT EXISTS cms_blog_series_items (
    ...
    'cms_podcast_chapters' => "CREATE TABLE IF NOT EXISTS cms_podcast_chapters (
        id                 INT            NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    'cms_podcast_people' => "CREATE TABLE IF NOT EXISTS cms_podcast_people (
        id          INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    'cms_podcast_platform_links' => "CREATE TABLE IF NOT EXISTS cms_podcast_platform_links (
        id           INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        show_id      INT          NOT NULL,
    ...
    'cms_downloads' => "CREATE TABLE IF NOT EXISTS cms_downloads (
        ...
        external_click_count INT          NOT NULL DEFAULT 0,
    ...
    'cms_appmarket_apps' => "CREATE TABLE IF NOT EXISTS cms_appmarket_apps (
        id                INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        name              VARCHAR(255) NOT NULL,
        slug              VARCHAR(150) NOT NULL,
        ...
        KEY idx_appmarket_apps_public (status, is_featured, sort_order, name)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",

    'cms_appmarket_certificates' => "CREATE TABLE IF NOT EXISTS cms_appmarket_certificates (
        id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        app_id             INT          NOT NULL,
        ...
        created_at         DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
        updated_at         DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        UNIQUE KEY uq_appmarket_certificate_fingerprint (app_id, fingerprint_sha256),
        KEY idx_appmarket_certificates_active (app_id, is_active, id)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",

    'cms_appmarket_releases' => "CREATE TABLE IF NOT EXISTS cms_appmarket_releases (
        id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        app_id             INT          NOT NULL,
        ...
        apk_storage_name   VARCHAR(255) NOT NULL DEFAULT '',
        apk_original_name  VARCHAR(255) NOT NULL DEFAULT '',
        apk_size           BIGINT UNSIGNED NOT NULL DEFAULT 0,
    ...
    'cms_appmarket_screenshots' => "CREATE TABLE IF NOT EXISTS cms_appmarket_screenshots (
        ...
        created_at DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
        updated_at DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        UNIQUE KEY uq_appmarket_screenshot_media (app_id, media_id),
        KEY idx_appmarket_screenshots_order (app_id, sort_order, id)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",

    'cms_appmarket_publish_tokens' => "CREATE TABLE IF NOT EXISTS cms_appmarket_publish_tokens (
        id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        app_id             INT          NOT NULL,
    ...
    'cms_food_order_items' => "CREATE TABLE IF NOT EXISTS cms_food_order_items (
        id                INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    'cms_recipes' => "CREATE TABLE IF NOT EXISTS cms_recipes (
        id               INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    'cms_recipe_ingredient_groups' => "CREATE TABLE IF NOT EXISTS cms_recipe_ingredient_groups (
        id         INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    'cms_recipe_ingredients' => "CREATE TABLE IF NOT EXISTS cms_recipe_ingredients (
        id          INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        recipe_id   INT          NOT NULL,
    ...
    'cms_recipe_steps' => "CREATE TABLE IF NOT EXISTS cms_recipe_steps (
        id             INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
        recipe_id      INT          NOT NULL,
        title          VARCHAR(255) NOT NULL DEFAULT '',
    ...
    'cms_stats_content_daily' => "CREATE TABLE IF NOT EXISTS cms_stats_content_daily (
        id              BIGINT       NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
try {
    ...
    $log[] = "✓ Výchozí kategorie receptů – OK";
} catch (\PDOException $e) {
    $log[] = "✗ Výchozí kategorie receptů – CHYBA: " . h($e->getMessage());
}
...
$addColumns = [
    ...
    'cms_gallery_albums.default_credit' => "ALTER TABLE cms_gallery_albums ADD COLUMN default_credit VARCHAR(255) NOT NULL DEFAULT '' AFTER cover_photo_id",
    'cms_gallery_albums.default_license_label' => "ALTER TABLE cms_gallery_albums ADD COLUMN default_license_label VARCHAR(100) NOT NULL DEFAULT '' AFTER default_credit",
    'cms_gallery_albums.default_license_url' => "ALTER TABLE cms_gallery_albums ADD COLUMN default_license_url VARCHAR(255) NOT NULL DEFAULT '' AFTER default_license_label",
    ...
    'cms_gallery_photos.alt_text'    => "ALTER TABLE cms_gallery_photos ADD COLUMN alt_text VARCHAR(255) NOT NULL DEFAULT '' AFTER slug",
    'cms_gallery_photos.caption'     => "ALTER TABLE cms_gallery_photos ADD COLUMN caption TEXT AFTER alt_text",
    'cms_gallery_photos.description' => "ALTER TABLE cms_gallery_photos ADD COLUMN description TEXT AFTER caption",
    'cms_gallery_photos.credit'      => "ALTER TABLE cms_gallery_photos ADD COLUMN credit VARCHAR(255) NOT NULL DEFAULT '' AFTER description",
    'cms_gallery_photos.license_label' => "ALTER TABLE cms_gallery_photos ADD COLUMN license_label VARCHAR(100) NOT NULL DEFAULT '' AFTER credit",
    'cms_gallery_photos.license_url' => "ALTER TABLE cms_gallery_photos ADD COLUMN license_url VARCHAR(255) NOT NULL DEFAULT '' AFTER license_label",
    'cms_gallery_photos.taken_at'    => "ALTER TABLE cms_gallery_photos ADD COLUMN taken_at DATE NULL DEFAULT NULL AFTER license_url",
    'cms_gallery_photos.location_label' => "ALTER TABLE cms_gallery_photos ADD COLUMN location_label VARCHAR(255) NOT NULL DEFAULT '' AFTER taken_at",
    ...
    'cms_food_sections.serving_note' => "ALTER TABLE cms_food_sections ADD COLUMN serving_note VARCHAR(255) NOT NULL DEFAULT '' AFTER serving_time_to",
    'cms_food_items.portion_label'   => "ALTER TABLE cms_food_items ADD COLUMN portion_label VARCHAR(80) NOT NULL DEFAULT '' AFTER price_note",
    'cms_food_items.energy_kj'       => "ALTER TABLE cms_food_items ADD COLUMN energy_kj INT NULL DEFAULT NULL AFTER portion_label",
    'cms_food_items.energy_kcal'     => "ALTER TABLE cms_food_items ADD COLUMN energy_kcal INT NULL DEFAULT NULL AFTER energy_kj",
    'cms_food_items.protein_g'       => "ALTER TABLE cms_food_items ADD COLUMN protein_g DECIMAL(8,2) NULL DEFAULT NULL AFTER energy_kcal",
    'cms_food_items.carbs_g'         => "ALTER TABLE cms_food_items ADD COLUMN carbs_g DECIMAL(8,2) NULL DEFAULT NULL AFTER protein_g",
    'cms_food_items.fat_g'           => "ALTER TABLE cms_food_items ADD COLUMN fat_g DECIMAL(8,2) NULL DEFAULT NULL AFTER carbs_g",
