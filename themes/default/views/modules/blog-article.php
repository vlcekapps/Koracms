  ...
  <article class="surface" aria-labelledby="clanek-nadpis">
          ...
          <div class="author-panel__content">
            ...
            <div class="button-row button-row--start">
              ...
              <?php if (!empty($article['author_website_url'])): ?>
                <a class="button-secondary" href="<?= h((string)$article['author_website_url']) ?>" target="_blank" rel="noopener noreferrer">Web autora<?= newWindowLinkSrOnlySuffix() ?></a>
              <?php endif; ?>
            </div>
          </div>
        </div>
    ...
    <div class="article-actions">
      ...
      <button type="button" class="button-secondary js-copy-link"
              data-url="<?= h(articlePublicUrl($article)) ?>">Kopírovat odkaz<span class="sr-only"> na článek</span></button>
    </div>
  </article>
