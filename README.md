...
- runtime guardrail pro blogovou administraci, který hlídá, že odkazy otevírané v novém okně používají sdílený `newWindowLinkLabel()` a čtečka obrazovky tak neuslyší jen běžný název odkazu bez informace o novém okně
