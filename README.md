...
- runtime guardrail pro administraci, který hlídá, že odkazy otevírané v novém okně v `admin/*.php` používají sdílený `newWindowLinkLabel()` a čtečka obrazovky tak neuslyší jen běžný název odkazu bez informace o novém okně
