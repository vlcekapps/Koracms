...
- runtime guardrail pro explicitní typy formulářových prvků, který vícerádkově hlídá PHP zdroje v `admin/`, `lib/` a `themes/`, aby se do administrace ani šablon nevrátily `<button>` nebo `<input>` bez `type`
