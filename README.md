...
- runtime HTML audit, který u skutečně vyrenderovaných veřejných i administračních odpovědí hlídá také iframe bez `title` a odkazy s `target="_blank"` bez bezpečného `rel` nebo bez přístupného oznámení nového okna
