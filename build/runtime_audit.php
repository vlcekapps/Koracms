...
$foundationChecks = [
    ...
    'phpstan covers stable helper batches' => str_contains($composerSource, '"analyse"')
        ...
        && str_contains($composerSource, 'admin/content_reference_picker.php admin/index.php admin/layout.php admin/login.php admin/login_2fa.php admin/logout.php admin/profile.php admin/settings.php admin/settings_modules.php admin/settings_save.php admin/settings_shared.php admin/themes.php author.php blog_router.php build/lint_php.php build/phpstan_bootstrap.php auth.php confirm_email.php cron.php db.php feed.php health.php index.php install.php maintenance.php migrate.php newsletter_widget_subscribe.php page.php public_login.php public_logout.php public_profile.php register.php reset_password.php robots.php search.php sitemap.php subscribe.php subscribe_confirm.php unsubscribe.php')
