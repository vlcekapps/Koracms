...
$foundationChecks = [
    ...
    'public file endpoints enforce HTTP methods' => str_contains($readOnlyMediaFileSource, 'requireReadOnlyHttpMethod();')
        ...
        && str_contains($readOnlyMediaThumbSource, 'sendNoSniffHeader();')
        ...
        && str_contains($readOnlyGalleryImageSource, 'sendNoSniffHeader();')
        && str_contains($readOnlyPlacesImageSource, '$isHeadRequest = requireReadOnlyHttpMethod();')
        && str_contains($readOnlyPlacesImageSource, 'sendNoSniffHeader();')
        ...
        && str_contains($readOnlyPodcastImageSource, 'sendNoSniffHeader();')
        && str_contains($readOnlyPodcastCoverSource, '$isHeadRequest = requireReadOnlyHttpMethod();')
        && str_contains($readOnlyPodcastCoverSource, 'sendNoSniffHeader();'),
