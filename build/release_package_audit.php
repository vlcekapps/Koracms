...
if (!is_file($releaseScriptPath)) {
    ...
    $requiredReleaseSnippets = [
        ...
        'Dry run: ACR Version evaluated bude při ostrém vydání nastavena na $newVersion.',
        'Invoke-Git @("add", "docs/accessibility/acr-vpat-wcag-draft.md")',
        'New-ReleaseZip -ProjectRoot $projectRoot -OutPath $zipPath -FileOverrides $packageFileOverrides',
        'pracovní VERSION, CHANGELOG.md a ACR draft zůstávají beze změn',
        'Dry run dokončen',
