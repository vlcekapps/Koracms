...
$projectRoot = mojibakeAuditProjectRoot(is_string($projectRootArgument) ? $projectRootArgument : null);
$issues = [];

function mojibakeAuditProjectRoot(?string $override): string
{
    $candidates = [];
    ...
    $environmentOverride = getenv('KORA_MOJIBAKE_AUDIT_ROOT');
