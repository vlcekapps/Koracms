...
$criticalInstallColumns = [
    ...
    'cms_appmarket_releases.supported_abis_json' => ['cms_appmarket_releases', 'supported_abis_json'],
    ...
    'cms_appmarket_releases.update_priority' => ['cms_appmarket_releases', 'update_priority'],
    'cms_appmarket_releases.required_below_version_code' => ['cms_appmarket_releases', 'required_below_version_code'],
    'cms_appmarket_releases.release_channel' => ['cms_appmarket_releases', 'release_channel'],
    'cms_appmarket_releases.rollout_percentage' => ['cms_appmarket_releases', 'rollout_percentage'],
    ...
    'cms_food_cards.order_fulfillment_modes' => ['cms_food_cards', 'order_fulfillment_modes'],
    'cms_food_cards.order_requested_at_enabled' => ['cms_food_cards', 'order_requested_at_enabled'],
    ...
    'cms_food_item_variants.item_id' => ['cms_food_item_variants', 'item_id'],
    'cms_food_item_variants.label' => ['cms_food_item_variants', 'label'],
    'cms_food_item_variants.portion_label' => ['cms_food_item_variants', 'portion_label'],
    'cms_food_item_variants.price_amount' => ['cms_food_item_variants', 'price_amount'],
    'cms_food_item_variants.is_available' => ['cms_food_item_variants', 'is_available'],
    ...
    'cms_food_orders.fulfillment_type' => ['cms_food_orders', 'fulfillment_type'],
    'cms_food_orders.requested_at' => ['cms_food_orders', 'requested_at'],
    'cms_food_orders.customer_address' => ['cms_food_orders', 'customer_address'],
    ...
    'cms_food_order_items.variant_id' => ['cms_food_order_items', 'variant_id'],
    'cms_food_order_items.variant_label' => ['cms_food_order_items', 'variant_label'],
    'cms_food_order_items.portion_label' => ['cms_food_order_items', 'portion_label'],
    'cms_food_order_items.quantity' => ['cms_food_order_items', 'quantity'],
    'cms_recipe_categories.slug' => ['cms_recipe_categories', 'slug'],
    'cms_recipe_categories.meta_title' => ['cms_recipe_categories', 'meta_title'],
    'cms_recipe_categories.is_active' => ['cms_recipe_categories', 'is_active'],
    'cms_recipes.category_id' => ['cms_recipes', 'category_id'],
    'cms_recipes.slug' => ['cms_recipes', 'slug'],
    'cms_recipes.dietary_flags' => ['cms_recipes', 'dietary_flags'],
    'cms_recipes.allergens' => ['cms_recipes', 'allergens'],
    'cms_recipes.media_id' => ['cms_recipes', 'media_id'],
    'cms_recipes.status' => ['cms_recipes', 'status'],
    'cms_recipe_ingredient_groups.recipe_id' => ['cms_recipe_ingredient_groups', 'recipe_id'],
    'cms_recipe_ingredients.recipe_id' => ['cms_recipe_ingredients', 'recipe_id'],
    'cms_recipe_ingredients.group_id' => ['cms_recipe_ingredients', 'group_id'],
    'cms_recipe_ingredients.quantity_min' => ['cms_recipe_ingredients', 'quantity_min'],
    'cms_recipe_ingredients.quantity_max' => ['cms_recipe_ingredients', 'quantity_max'],
    'cms_recipe_ingredients.name' => ['cms_recipe_ingredients', 'name'],
    'cms_recipe_steps.recipe_id' => ['cms_recipe_steps', 'recipe_id'],
    'cms_recipe_steps.instruction' => ['cms_recipe_steps', 'instruction'],
    'cms_recipe_steps.media_id' => ['cms_recipe_steps', 'media_id'],
    'cms_recipe_structure_snapshots.recipe_id' => ['cms_recipe_structure_snapshots', 'recipe_id'],
    'cms_recipe_structure_snapshots.snapshot_json' => ['cms_recipe_structure_snapshots', 'snapshot_json'],
