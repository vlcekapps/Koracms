...
- **Veřejné styly šablon** – skip link, `sr-only`, cookie lišta a veřejný admin bar se na běžných veřejných stránkách stylují ze sdíleného `assets/public-core.css` místo generovaného inline `<style>` helperu; instalační a migrační obrazovky si ponechávají samostatný fallback.
