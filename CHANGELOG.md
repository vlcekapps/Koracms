...
### Změněno
- **Code style guardrail – PHP-CS-Fixer smoke check nově pokrývá i admin moderaci zpráv** – `composer ci:basic` nově spouští samostatný `composer format:check:admin-moderation` pro přehled komentářů, kontaktů a chatu; soubory byly dorovnány na stejný PSR-12 styl bez změny chování.
