...
- **Správa blogů v administraci** – formulář vytvoření blogu, přehled blogů, dialog úprav, náhled loga a modální zamknutí stránky používají nonce CSS třídy a `hidden` místo lokálních `style` atributů nebo JS mutací `element.style`; runtime audit hlídá návrat starého vzoru.
