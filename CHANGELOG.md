...
- **Nastavení webu v administraci** – navigace sekcí, profil webu, komentáře, notifikace, vlastní kód, náhled loga a favicon i akční tlačítko používají nonce CSS třídy místo lokálních `style` atributů; runtime audit hlídá návrat starého vzoru.
