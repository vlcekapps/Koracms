...
- **Code style guardrail – PHP-CS-Fixer smoke check nově pokrývá i vybrané admin maintenance obrazovky** – `composer ci:basic` nově spouští samostatný `composer format:check:admin-maintenance` pro nastavení, statistiky, eStránky import/stahování fotografií, WordPress import a revize obsahu; soubory byly dorovnány na stejný PSR-12 styl bez změny chování.
