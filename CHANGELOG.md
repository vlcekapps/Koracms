...
- **Content/media picker v administraci** – dialog, překryv, stavová hláška a vyhledávací fieldset používají CSS třídy a atribut `hidden` místo lokálních `style` atributů nebo JS mutací `element.style`; runtime audit hlídá, aby se starý vzor nevrátil.
