...
- **HTTP smoke test veřejných modulů** – HTTP integrace nově projde všechny veřejné modulové entrypointy z centrálního manifestu, zapne jejich `module_*` přepínače a ověří, že se nenačte vypnutý modul ani PHP chyba.
