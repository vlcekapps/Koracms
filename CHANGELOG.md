...
### Opraveno
- **Odkazy otevírané v novém okně ve veřejné šabloně** – veřejné odkazy autora, podcastu, stahování, událostí, míst a footer odkaz na Kora CMS nově doplňují přístupný název s informací, že se odkaz otevře v novém okně; sdílený helper sjednocuje stejnou copy i pro externí odkazy v menu a blogových stránkách.
