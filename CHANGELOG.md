...
- **Rezervace v administraci** – přehled rezervací, ruční vytvoření rezervace a detail rezervace používají nonce CSS třídy a atribut `hidden` místo lokálních `style` atributů nebo JS mutací `element.style`; runtime audit hlídá návrat starého vzoru.
