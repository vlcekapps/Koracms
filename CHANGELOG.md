...
- **Error suggestion pro uploady v knihovně médií** – hromadný upload a náhrada souboru po selhání nově napojují chybu i na konkrétní file input přes `aria-describedby`; text radí podporovaný formát do 10 MB, zákaz SVG, stejnou MIME rodinu a u veřejné náhrady stejnou příponu.
