...
- **Navigace webu a přehled anket v administraci** – řadicí seznam hlavní navigace, filtr anket, metadata a stavové štítky používají sdílené administrační třídy místo lokálních `style` atributů; runtime audit hlídá jejich návrat.
