...
- **Necacheované tokenové a odhlašovací endpointy** – potvrzení e-mailu, potvrzení/odhlášení newsletteru, reset hesla a veřejné i administrační odhlášení nově posílají `Cache-Control: no-store, max-age=0` a `X-Robots-Tag: noindex, nofollow, noarchive`; sociální crawler cache výjimka pro články je u těchto citlivých URL výslovně potlačená.
