...
- **CI a vývojové kontroly – GitHub Actions používá `actions/checkout@v6` a PHPStan nově pokrývá širší sadu stabilních helperů na levelu 1** – základní CI už nemá varování kvůli Node 20 checkout akci a statická analýza má bezpečný bootstrap i symbol scan bez DB/session side efektů; zahrnuje mimo jiné `lib/content.php`, `lib/github.php`, `lib/media_library.php`, `lib/theme.php`, `lib/ui.php` a `lib/widgets.php`.
