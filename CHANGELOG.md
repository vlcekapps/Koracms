...
### Opraveno
- **Upload hardening příloh a galerií** – přílohy vývěsky, lokální soubory ke stažení a hromadné nahrávání fotografií galerie nově používají sdílené upload helpery pro kontrolu PHP upload stavu, dočasného souboru, typu/formátu a finálního uložení; runtime audit hlídá, aby se do těchto handlerů nevrátila vlastní `finfo`/`move_uploaded_file` logika.
