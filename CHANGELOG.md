...
- **Kontrola integrity v administraci** – stavové panely, akční řádek, výsledky kontroly a informační blok používají nonce CSS třídy místo lokálních `style` atributů; runtime audit hlídá, aby se prezentační inline styly do obrazovky nevracely.
...
- **Detail odpovědi formuláře v administraci** – workflow pole, GitHub issue návrh, odpověď odesílateli, historie a mazací formulář používají nonce CSS třídy místo lokálních `style` atributů; runtime audit hlídá návrat inline stylů na detailu hlášení.
