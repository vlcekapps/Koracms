...
- **Přihlašovací obrazovky administrace** – `admin/login.php` a `admin/login_2fa.php` používají sdílený CSS helper s CSP nonce místo duplicitních lokálních `<style>` bloků; runtime audit hlídá návrat lokálních stylů na obou obrazovkách.
