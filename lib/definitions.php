...
function coreModuleDefinitions(): array
{
    return [
        'blog' => [
            ...
            'widget_label' => 'Blog',
            'admin_label' => 'Blog',
            'admin_capability' => 'blog_manage_own',
        ...
        'news' => [
            ...
            'admin_label' => 'Novinky',
            'admin_capability' => 'news_manage_own',
        ...
        'chat' => [
            ...
            'widget_label' => 'Chat',
            'admin_label' => 'Chat',
            'admin_capability' => 'messages_manage',
        ...
        'gallery' => [
            ...
            'admin_label' => 'Galerie',
            'admin_capability' => 'content_manage_shared',
        ...
        'newsletter' => [
            ...
            'admin_capability' => 'newsletter_manage',
            'content_reference_types' => [],
            'search_result_types' => [],
            'sitemap_sections' => [],
            'stats_page_types' => [],
        ...
        'appmarket' => [
            ...
            'admin_capability' => 'appmarket_manage',
            'content_reference_types' => [],
            'search_result_types' => ['appmarket_app' => 'Aplikace'],
            'sitemap_sections' => [
                'appmarket_apps' => 'Aplikace',
                'appmarket_releases' => 'Vydání aplikací',
            ],
            'stats_page_types' => ['appmarket_app', 'appmarket_release'],
            'database_tables' => [
                'cms_appmarket_apps',
            ...
            'settings_default' => '0',
            'public_nav_path' => '/appmarket/index.php',
            'public_paths' => [
                '/appmarket/index.php',
                '/appmarket/app.php',
            ...
            'admin_paths' => [
                '/admin/appmarket.php',
                '/admin/appmarket_form.php',
                '/admin/appmarket_save.php',
                '/admin/appmarket_release_form.php',
                '/admin/appmarket_release_save.php',
                '/admin/appmarket_release_review.php',
                '/admin/appmarket_release_action.php',
                '/admin/appmarket_certificates.php',
                '/admin/appmarket_tokens.php',
            ],
        ],
        'downloads' => [
            'label' => 'Ke stažení',
        ...
        'recipes' => [
            'label' => 'Recepty',
            'settings_label' => 'Recepty',
            'nav_label' => 'Recepty',
            'widget_label' => 'Recepty',
            'admin_label' => 'Recepty',
            'admin_capability' => 'content_manage_shared',
            'content_reference_types' => ['recipe' => 'Recepty'],
            'search_result_types' => ['recipe' => 'Recept'],
            'sitemap_sections' => [
                'recipes' => 'Recepty',
                'recipe_categories' => 'Kategorie receptů',
            ],
            'stats_page_types' => ['recipe'],
            'database_tables' => [
            ...
            'settings_default' => '0',
            'public_nav_path' => '/recipes/index.php',
            'public_paths' => [
                '/recipes/index.php',
                '/recipes/recipe.php',
                '/recipes/cookbook.php',
                '/recipes/shopping.php',
            ],
            'public_nav_order' => 85,
            'profile_managed' => true,
            'settings_configurable' => true,
            ...
            'admin_paths' => [
                '/admin/recipes.php',
                '/admin/recipe_form.php',
                '/admin/recipe_content.php',
                '/admin/recipe_history.php',
                '/admin/recipe_categories.php',
            ],
        ],
        'polls' => [
            'label' => 'Ankety',
        ...
        'reservations' => [
            ...
            'admin_capability' => 'bookings_manage',
            'content_reference_types' => [],
        ...
        'statistics' => [
            ...
            'admin_capability' => 'statistics_view',
            'content_reference_types' => [],
            'search_result_types' => [],
            'sitemap_sections' => [],
            'stats_page_types' => [],
 ...
 * @return array<string, list<string>>
 */
function moduleStatsPageTypes(): array
{
    $types = [];
    foreach (coreModuleDefinitions() as $moduleKey => $definition) {
        $pageTypes = $definition['stats_page_types'];
        if ($pageTypes === []) {
            continue;
        }
        ...
        foreach ($pageTypes as $pageType) {
            ...
            if ($pageType !== '') {
                $normalizedPageTypes[] = $pageType;
            }
        }

        $normalizedPageTypes = array_values(array_unique($normalizedPageTypes));
        if ($normalizedPageTypes !== []) {
            $types[$moduleKey] = $normalizedPageTypes;
        }
    }
 ...
 * @return array<string,string>
 */
function moduleStatsPageTypeMap(): array
{
    $map = [];
...
function moduleAdminCapability(string $moduleKey): string
{
    $definition = coreModuleDefinitions()[$moduleKey] ?? null;
    if ($definition === null) {
        return 'admin_access';
    ...
    $capability = trim($definition['admin_capability']);
    return $capability !== '' ? $capability : 'admin_access';
}
...
function siteProfileDefinitions(): array
{
    return [
        'personal' => [
            ...
            'nav_order' => ['blog', 'contact', 'gallery', 'news', 'events', 'podcast', 'newsletter', 'downloads', 'faq', 'chat', 'places', 'food', 'recipes', 'polls', 'board', 'reservations'],
            'settings' => [
                'home_blog_count' => '6',
                'home_news_count' => '0',
                'home_board_count' => '0',
        ...
        'blog' => [
            ...
            'nav_order' => ['blog', 'gallery', 'contact', 'newsletter', 'news', 'events', 'podcast', 'downloads', 'faq', 'chat', 'places', 'food', 'recipes', 'polls', 'board', 'reservations'],
            'settings' => [
                'home_blog_count' => '8',
                'home_news_count' => '0',
                'home_board_count' => '0',
        ...
        'civic' => [
            ...
            'nav_order' => ['news', 'events', 'board', 'downloads', 'faq', 'blog', 'gallery', 'places', 'contact', 'newsletter', 'chat', 'food', 'recipes', 'polls', 'reservations', 'podcast'],
            'settings' => [
                'home_blog_count' => '3',
                'home_news_count' => '5',
                'home_board_count' => '5',
        ...
        'service' => [
            ...
            'nav_order' => ['blog', 'gallery', 'faq', 'contact', 'newsletter', 'news', 'events', 'downloads', 'chat', 'places', 'food', 'recipes', 'polls', 'board', 'reservations', 'podcast'],
            'settings' => [
                'home_blog_count' => '4',
                'home_news_count' => '0',
                'home_board_count' => '0',
