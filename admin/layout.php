...
function adminHeader(string $pageTitle): void
{
    ...
    echo '<!DOCTYPE html>' . "\n"
       ...
       . '    .res-resource-intro { margin-top:0; font-size:.9rem; }' . "\n"
       . '    .res-resource-location-fieldset { border:1px solid #ddd; padding:.5rem .75rem; margin-top:1rem; }' . "\n"
       . '    .res-resource-empty-copy { margin:.25rem 0; font-size:.9rem; }' . "\n"
       . '    .res-resource-location-row { margin:.25rem 0; }' . "\n"
       . '    .res-resource-location-address { color:#666; }' . "\n"
       . '    .res-resource-manage-link { margin:.5rem 0 0; font-size:.85rem; }' . "\n"
       . '    .res-resource-fieldset { border:1px solid #ccc; padding:.5rem 1rem; margin-top:1rem; }' . "\n"
       . '    .res-resource-mode-fieldset { border:0; padding:0; margin:1rem 0 0; }' . "\n"
       . '    .res-resource-option-row { margin:.3rem 0; }' . "\n"
       . '    .res-resource-help-indented { margin:.15rem 0 0 1.6rem; }' . "\n"
       . '    .res-resource-help-tight { margin-top:.2rem; }' . "\n"
       . '    .res-resource-check-row { margin-top:1rem; }' . "\n"
       . '    .res-resource-check-row--compact { margin-top:.5rem; }' . "\n"
       . '    .res-resource-generator { border:1px dashed #aaa; padding:.5rem 1rem; margin-bottom:1rem; }' . "\n"
       . '    .res-resource-inline-grid { display:flex; gap:.5rem; align-items:flex-end; flex-wrap:wrap; }' . "\n"
       . '    .res-resource-inline-control { width:auto; display:block; margin-top:.2rem; }' . "\n"
       . '    .res-resource-inline-control--number { width:5rem; }' . "\n"
       . '    .res-resource-inline-button { margin-bottom:.2rem; }' . "\n"
       . '    .res-resource-day-fieldset { border:1px solid #ddd; padding:.3rem .5rem; margin-bottom:.5rem; }' . "\n"
       . '    .res-resource-slot-row, .res-resource-blocked-row { display:flex; gap:.4rem; align-items:center; margin-bottom:.3rem; flex-wrap:wrap; }' . "\n"
       . '    .res-resource-input-xxs { width:4rem; }' . "\n"
       . '    .res-resource-add-slot { margin-top:.2rem; }' . "\n"
       . '    .res-resource-blocked-grid { margin-bottom:.5rem; }' . "\n"
       . '    .res-resource-actions { margin-top:1.5rem; }' . "\n"
       . '    .form-builder-preset { margin-bottom:1rem; }' . "\n"
       . '    .form-builder-preset-list-intro { margin-bottom:.5rem; }' . "\n"
       . '    .form-builder-preset-list, .form-builder-placeholder-list { margin:0; padding-left:1.25rem; }' . "\n"
       . '    .form-builder-placeholder-list { margin-top:.75rem; }' . "\n"
       . '    .form-builder-row { margin-bottom:.75rem; }' . "\n"
       . '    .form-builder-control-md { width:100%; max-width:500px; }' . "\n"
       . '    .form-builder-control-lg { width:100%; max-width:700px; }' . "\n"
       . '    .form-builder-control-xl { width:100%; max-width:52rem; }' . "\n"
       . '    .form-builder-control-secret { width:100%; max-width:32rem; }' . "\n"
       . '    .form-builder-input-sm { width:7rem; }' . "\n"
       . '    .form-builder-preview { margin-top:1rem; border:1px solid var(--admin-border); border-radius:8px; padding:1rem; background:var(--admin-surface); }' . "\n"
       . '    .form-builder-preview-title, .form-builder-help-flush { margin-top:0; }' . "\n"
       . '    .form-builder-preview-box, .form-builder-preview-message { margin-top:.35rem; padding:.65rem .75rem; border:1px solid var(--admin-border); border-radius:6px; background:var(--admin-input-bg); }' . "\n"
       . '    .form-builder-preview-message { margin:.35rem 0 0; padding:.75rem; white-space:pre-wrap; font:inherit; }' . "\n"
       . '    .form-builder-action-grid { display:grid; grid-template-columns:minmax(14rem,1fr) minmax(18rem,1.2fr); gap:.75rem; align-items:end; margin-top:.5rem; }' . "\n"
       . '    .form-builder-event-fieldset { border:1px solid var(--admin-border); padding:.75rem 1rem; }' . "\n"
       . '    .form-builder-event-row { margin:.35rem 0; }' . "\n"
       . '    .form-builder-field-card { border:1px solid var(--admin-border); border-radius:8px; padding:.75rem; margin-bottom:.75rem; background:var(--admin-surface); }' . "\n"
       . '    .form-builder-field-grid { display:grid; grid-template-columns:minmax(12rem,1.4fr) minmax(10rem,.9fr) minmax(12rem,1fr) minmax(12rem,1fr) minmax(11rem,.9fr) 6rem; gap:.5rem; align-items:end; }' . "\n"
       . '    .form-builder-field-grid--secondary { grid-template-columns:minmax(12rem,1fr) minmax(12rem,1fr) minmax(10rem,.8fr) minmax(11rem,.9fr); margin-top:.5rem; }' . "\n"
       . '    .form-builder-condition-grid { display:grid; grid-template-columns:minmax(12rem,1fr) minmax(12rem,.9fr) minmax(12rem,1fr); gap:.5rem; align-items:end; margin-top:.5rem; }' . "\n"
       . '    .form-builder-check-row { display:flex; gap:1rem; align-items:center; flex-wrap:wrap; margin-top:.5rem; }' . "\n"
       . '    .form-builder-check-row label { font-weight:normal; }' . "\n"
       . '    .form-builder-new-field { border:1px dashed var(--admin-border); border-radius:8px; padding:.75rem; background:var(--admin-input-bg); }' . "\n"
       . '    .form-builder-actions { margin-top:1rem; }' . "\n"
