...
function adminFooter(): void
{
    ...
    echo '<script nonce="' . $nonce . '">document.addEventListener("DOMContentLoaded",function(){'
       ...
       . 'banner.style.cssText=\'background:#fff4df;border:1px solid #c77700;color:#7a4300;padding:.7rem 1rem;border-radius:6px;margin-bottom:1rem;display:flex;align-items:center;gap:.7rem;flex-wrap:wrap\';'
       ...
       . 'info.style.cssText=\'display:block;margin-top:.3rem;color:#666;font-size:.8rem\';'
       ...
       . 'box.style.cssText="margin-top:.8rem;padding:.8rem;background:#fff;border:1px solid #ddd;border-radius:8px;font-family:arial,sans-serif;max-width:600px";'
       . 'box.innerHTML=\'<div style="font-size:1.1rem;color:#1a0dab;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" id="seo-prev-title"></div>\''
       . '+\'<div style="font-size:.8rem;color:#006621;margin:.2rem 0" id="seo-prev-url"></div>\''
       . '+\'<div style="font-size:.85rem;color:#545454;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden" id="seo-prev-desc"></div>\''
       . '+\'<small style="color:#999;margin-top:.4rem;display:block" id="seo-prev-counts"></small>\';'
