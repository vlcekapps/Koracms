    ...
    <tr>
      ...
      <td>
        ...
        <?php if ($resourcePublicPath !== ''): ?>
          <br><small><a href="<?= h($resourcePublicPath) ?>" target="_blank" rel="noopener noreferrer" aria-label="<?= h(newWindowLinkLabel('Zobrazit zdroj na webu')) ?>">Zobrazit zdroj na webu</a></small>
        <?php endif; ?>
      </td>
    </tr>
