...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $pdo->exec("CREATE TABLE IF NOT EXISTS cms_appmarket_certificates (
            id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
            app_id             INT          NOT NULL,
        ...
        $pdo->exec("CREATE TABLE IF NOT EXISTS cms_appmarket_releases (
            id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
            app_id             INT          NOT NULL,
        ...
        $pdo->exec("CREATE TABLE IF NOT EXISTS cms_appmarket_publish_tokens (
            id                 INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
            app_id             INT          NOT NULL,
