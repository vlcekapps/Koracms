...
- `composer ci:basic` spustí PHP lint, PHPStan a unit testy; PHPStan používá bezpečný bootstrap `build/phpstan_bootstrap.php`, který nenačítá databázi ani session
