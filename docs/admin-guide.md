...
- Runtime audit u blogové administrace hlídá také odkazy otevírané v novém okně. Pokud má blogový admin odkaz `target="_blank"`, musí používat sdílený `newWindowLinkLabel()`, aby bylo otevření v novém okně součástí přístupného názvu odkazu.
