...
Tento odkaz je součástí WCAG 2.2 `3.2.6 Consistent Help` evidence. Pokud nový modul zavádí vlastní podporu, inbox, kontaktní workflow nebo redakční pravidla, zvažte doplnění této stránky nebo dokumentace tak, aby správce nemusel hledat nápovědu na každé obrazovce jiným způsobem.
