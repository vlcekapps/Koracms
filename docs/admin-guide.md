...
- `composer analyse:strict` už na levelu 6 vedle základních helperů pokrývá i `admin/content_reference_picker.php`, `admin/index.php`, `admin/layout.php`, `admin/login.php`, `admin/login_2fa.php`, `admin/logout.php`, `admin/media.php`, `admin/page_form.php`, `admin/page_positions.php`, `admin/page_reorder.php`, `admin/page_save.php`, `admin/pages.php`, `admin/profile.php`, `admin/settings.php`, `admin/settings_modules.php`, `admin/settings_save.php`, `admin/settings_shared.php`, `admin/themes.php`, `author.php`, `blog_router.php`, `auth.php`, `confirm_email.php`, `cron.php`, `db.php`, `feed.php`, `health.php`, `index.php`, `install.php`, `maintenance.php`, `migrate.php`, `newsletter_widget_subscribe.php`, `page.php`, `public_login.php`, `public_logout.php`, `public_profile.php`, `register.php`, `reset_password.php`, `robots.php`, `search.php`, `sitemap.php`, `subscribe.php`, `subscribe_confirm.php`, `unsubscribe.php`, `comments`, `content`, `definitions`, `gallery`, `github`, `mail`, `media_library`, `messages`, `presentation`, `revisions`, `stats`, `theme`, `ui`, `webhooks` a `widgets`; ta část kódu proto nově drží přesnější array kontrakty i bez baseline a bez ignore pravidel
