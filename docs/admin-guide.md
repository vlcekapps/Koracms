...
- Navigace webu a přehled anket v administraci používají sdílené utility třídy pro řadicí seznam, popisy, filtry, metadata a stavové štítky místo lokálních `style` atributů; runtime audit hlídá, aby se čistě prezentační inline styly do těchto obrazovek nevracely.
