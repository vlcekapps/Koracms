...
7. Editor blogového článku, statické stránky a FAQ: dlouhá editace, content lock heartbeat, uložení a chybové stavy. U statické stránky ověřit chyby názvu, slugu, přiřazeného blogu, plánovaného publikování a plánovaného zrušení publikace; u FAQ ověřit prázdnou otázku/odpověď a neplatný nebo duplicitní slug. Souhrnný `role="alert"` má upozornit na dotčené pole, pole má mít `aria-invalid`, `aria-describedby` na existující nápovědu/chybu a text má radit konkrétní opravu.
