...
- 2026-07-06: automatizovaný guardrail pro WCAG `3.3.4 Error Prevention` pokrývá trvalé smazání v administrativním Koši, změnu role existujícího uživatelského účtu a odeslání newsletter rozesílky. HTTP scénáře ověřují review text u konkrétní položky, povinný potvrzovací checkbox, serverové odmítnutí nepotvrzeného purge, potvrzené trvalé smazání, review aktuální/nové role, odmítnutí nepotvrzené změny role, uloženou potvrzenou změnu, review počtu příjemců newsletteru a odmítnutí nepotvrzené rozesílky bez zápisu do historie. Ručně zbývá produktově projít další právně/datově kritické akce mimo koš, role a newsletter rozesílku.
