...
- 2026-07-06: automatizovaný guardrail pro WCAG `3.3.4 Error Prevention` pokrývá trvalé smazání v administrativním Koši, změnu role existujícího uživatelského účtu, odeslání newsletter rozesílky, hromadné akce nad odběrateli newsletteru a datově dopadající importy. HTTP scénáře ověřují review text u konkrétní položky, povinný potvrzovací checkbox, serverové odmítnutí nepotvrzeného purge, potvrzené trvalé smazání, review aktuální/nové role, odmítnutí nepotvrzené změny role, uloženou potvrzenou změnu, review počtu příjemců newsletteru, odmítnutí nepotvrzené rozesílky bez zápisu do historie, odmítnutí nepotvrzeného bulk delete bez smazání odběratele a odmítnutí validního JSON importu bez změny nastavení nebo newsletter historie. Ručně zbývá produktově projít další právně/datově kritické akce mimo koš, role, newsletter a importy.
- 2026-07-06: automatizovaný guardrail pro WCAG 2.2 `3.3.7 Redundant Entry` pokrývá veřejný kontakt, Food objednávku a přihlášené veřejné rezervace: `currentUserContactDefaults()` čte jméno, e-mail a telefon z profilu, HTTP integrace ověřuje předvyplnění v renderu kontaktu/Food, zachování ručně upravených POST hodnot po chybě a u rezervací také uložení kontaktního snapshotu bez opakované kontaktní výzvy nebo captchy. Ručně zbývá projít širší auth/objednávková/custom flow, okrajové rezervační scénáře a potvrdit, že předvyplnění nebo vynechání opakovaného zadání není matoucí na sdíleném zařízení.
