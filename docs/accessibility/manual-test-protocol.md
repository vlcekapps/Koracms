...
- 2026-07-06: automatizovaný guardrail pro WCAG `3.3.4 Error Prevention` pokrývá trvalé smazání v administrativním Koši, změnu role existujícího uživatelského účtu, odeslání newsletter rozesílky a hromadné akce nad odběrateli newsletteru. HTTP scénáře ověřují review text u konkrétní položky, povinný potvrzovací checkbox, serverové odmítnutí nepotvrzeného purge, potvrzené trvalé smazání, review aktuální/nové role, odmítnutí nepotvrzené změny role, uloženou potvrzenou změnu, review počtu příjemců newsletteru, odmítnutí nepotvrzené rozesílky bez zápisu do historie a odmítnutí nepotvrzeného bulk delete bez smazání odběratele. Ručně zbývá produktově projít další právně/datově kritické akce mimo koš, role a newsletter.
