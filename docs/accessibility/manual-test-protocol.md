...
- 2026-07-06: automatizovaný guardrail pro WCAG `3.3.4 Error Prevention` pokrývá trvalé smazání v administrativním Koši a změnu role existujícího uživatelského účtu. HTTP scénáře ověřují review text u konkrétní položky, povinný potvrzovací checkbox, serverové odmítnutí nepotvrzeného purge, potvrzené trvalé smazání, review aktuální/nové role, odmítnutí nepotvrzené změny role a uloženou potvrzenou změnu. Ručně zbývá produktově projít další právně/datově kritické akce mimo koš a role.
