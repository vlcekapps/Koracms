...
| 4.1.3 Status Messages | Supports | Status and error messages use live region semantics and guarded roles. The reservation resource editor now keeps client-side validation feedback in named inline alert regions instead of browser alert dialogs. |
