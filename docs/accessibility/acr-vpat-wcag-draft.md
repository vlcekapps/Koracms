...
| 3.1.2 Language of Parts | Partially Supports | Authors can add HTML language attributes and the author-content checklist documents `lang` examples, but CMS does not enforce language-of-parts markup or provide a toolbar helper yet. |
