...
| 1.4.10 Reflow | AA | Partially Supports | Veřejná vrstva i administrace mají responzivní baseline; na mobilní šířce se admin navigace skládá nad obsah, datové tabulky rolují lokálně a komplexní gridy spadají do jednoho sloupce. Statistiky, přehled formulářů a husté tabulkové moduly administrace mají doplněné responzivní wrappery, aby neroztahovaly celou stránku. | Theme view audit, runtime smoke, `admin_mobile_reflow_guardrails` a browser ověření 320 px dne 2026-07-04 pro media, widgets, statistics, Form Builder, přehled formulářů, comments, contact, chat, reservations, food, downloads, gallery, importy a content picker. | Ručně rozšířit 320 px / 400 % průchod na dlouhé editační formuláře, méně časté custom moduly a kombinace s NVDA/keyboard-only. |
...
| 2.4.11 Focus Not Obscured (Minimum) | AA | Partially Supports | Skip link a sticky prvky mají offsety; admin mobilní baseline nemá fixed sidebar, command dialog i content picker se na malé šířce vejdou do viewportu a focus v mobilní admin navigaci byl ověřený jako viditelný. | Blog TOC scroll offset, layout CSS, `admin_mobile_reflow_guardrails`, browser ověření admin hledání a content picker dialogu při 320 px dne 2026-07-04. | Ručně ověřit sticky header/admin bar, anchor skoky a dlouhé editační formuláře při 320 px / 400 % zoomu. |
...
| 2.5.8 Target Size (Minimum) | AA | Partially Supports | Veřejná UI míří na dostatečné cíle; admin tlačítka, mobilní navigace, řadicí ovladače, sekundární odkazy v action rows a ověřené řádkové akce mají sdílené minimální rozměry nebo flex rozložení. | CSS, runtime `admin_mobile_reflow_guardrails` a browser ověření 320 px bez cílů pod 24 px v media, widgets, statistics, Form Builderu, přehledu formulářů, contact/chat/food/downloads/gallery a content pickeru. | Ručně změřit ikonové akce a méně časté custom module controls. |
