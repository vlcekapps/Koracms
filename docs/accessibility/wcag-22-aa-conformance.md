...
| 3.3.8 Accessible Authentication (Minimum) | AA | Partially Supports | Login a 2FA jsou standardní, ale captcha/auth flow vyžaduje ruční WCAG 2.2 posouzení. | Login, 2FA, public auth. | Ověřit, že autentizace nevyžaduje nepřístupný kognitivní test bez alternativy. |
