...
| Error suggestions | 3.3.3 | Základní veřejné chyby matematického ověření, vybrané administrační URL chyby a plánovací datum/čas chyby včetně rezervačních zdrojů už radí konkrétní opravu, ale méně časté administrační a custom validační chyby mohou pořád jen označit hodnotu za chybnou. | Pokračovat copy passem nad zbývajícími administračními, custom a méně častými chybami formulářů a doplnit konkrétní návrhy. |
