...
| Reflow dlouhých formulářů a custom modulů | 1.4.10, 2.4.11, 2.5.8 | Browser průchody 2026-07-04 pokryly hlavní husté admin tabulky, importy a content picker při 320 px. Zbývají dlouhé editační formuláře, méně časté custom moduly a kombinace 400 % zoom + asistivní technologie. | Rozšířit ruční průchod na blog/news/event/page/download/gallery/food formuláře, custom module admin obrazovky a keyboard-only/NVDA scénáře. |
