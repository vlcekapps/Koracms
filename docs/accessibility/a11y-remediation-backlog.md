...
| Error suggestions | 3.3.3 | Základní veřejné chyby matematického ověření už radí přepočítat příklad a zadat jen číslo, ale méně časté administrační a custom validační chyby mohou pořád jen označit hodnotu za chybnou. | Udělat copy pass nad administračními, custom a méně častými chybami formulářů a doplnit konkrétní návrhy. |
